	...
	<body>
		...
		<div id="bar">
			<form action="login.php" method="post">
				...
				<input type="submit" value="Login"/><input type="reset" value="Cancel"/><a href="lanreg.php" style="position:relative;right:10px;color:#fff;text-decoration:none;">Sign Up</a>
			</form>
		</div>
	</body>
</html>